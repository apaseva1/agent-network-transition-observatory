...
RFP-ENDPOINT-BOUNDARY:
DETERMINISTIC_SYNTHETIC_R1 != FUNDED_HIGH_FIDELITY_ENDPOINT
...
- **Funded Work Scope**: The funded trajectory tests external validity under higher-fidelity conditions involving:
  ...
  - Frontier-model agent conditions

This boundary ensures that no reviewer or public audience is misled into conflating deterministic synthetic validation with live frontier AI risk detection.
